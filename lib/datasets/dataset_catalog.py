...
DATASETS = {
    ...
    'human_par_train': {
        ...
        ANN_FN:
            _DATA_DIR + '/human_parsing+attribute/datasets/parsing_train.json'
    },
    'human_par_val': {
        IM_DIR:
            _DATA_DIR + '/human_parsing+attribute/parsing/val/images',
        ANN_FN:
            _DATA_DIR + '/human_parsing+attribute/datasets/parsing_val.json'
    },
    'human_par_test': {
        IM_DIR:
    ...
    'coco_2014_train': {
        IM_DIR:
            _DATA_DIR + '/coco/data/coco_train2014',
        ANN_FN:
            _DATA_DIR + '/coco/annotations/instances_train2014.json'
    },
    'coco_2014_val': {
        IM_DIR:
            _DATA_DIR + '/coco/data/coco_val2014',
        ANN_FN:
    ...
    'coco_2015_test': {
        IM_DIR:
            _DATA_DIR + '/coco/data/coco_test2015',
        ANN_FN:
